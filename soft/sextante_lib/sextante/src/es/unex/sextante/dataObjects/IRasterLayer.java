...
public interface IRasterLayer
   ...
   /**
    * Returns an accumulated histogram of the first band of this layer
    * 
    * @return an accumulated histogram of the first band of this layer
    */
