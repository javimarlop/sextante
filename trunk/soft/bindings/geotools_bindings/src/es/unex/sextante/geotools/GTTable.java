...
public class GTTable
   ...
   public void postProcess() {
      ...
      if (m_BaseDataObject != null) {
         ...
         try {
            final DbaseFileHeader header = createDbaseHeader();
            final WritableByteChannel out = new FileOutputStream(m_sFilename).getChannel();
            writer = new DbaseFileWriter(header, out);
            final IRecordsetIterator iter = this.iterator();
            while (iter.hasNext()) {
