...
public class MergeToolboxAction
         extends
            ToolboxAction {
   ...
   public void execute() {
      ...
      final IGeoprocessUserEntries panel = new GeoProcessingMergePanel2(new GlobalFLayers());
      final GeoprocessPaneContainer container = new GeoprocessPaneContainer((JPanel) panel);
      final MergeGeoprocessController controller = new MergeGeoprocessController();
   ...
   public String getName() {
      ...
      return PluginServices.getText(null, "Merge");
