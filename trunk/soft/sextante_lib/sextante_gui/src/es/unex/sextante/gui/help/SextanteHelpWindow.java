...
public class SextanteHelpWindow
   ...
   public void fillTree() {
      ...
      final DefaultMutableTreeNode generalNode = new DefaultMutableTreeNode(Sextante.getText("Basic_concepts"));
      /*generalNode.add(new DefaultMutableTreeNode(new ObjectAndDescription(Sextante.getText("Introduction"),
