...
\date{}
\title{
{\LARGE \bfseries SEXTANTE Programming Guide} 
\vspace*{0.5cm}
\rule{\textwidth}{1pt}
}
\author
...
Copyright \copyright  2008 Victor Olaya\\
...
\begin{mainmatter}
\input{Intro}
\input{UsingGeoalgorithms}
\input{ProgrammingGeoalgorithms}
\input{DevelopingBindings}
%\input{CompilingSextante}
\input{SettingUpSextanteGvSIG}
\end{mainmatter}
