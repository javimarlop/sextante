...
Let's have the following code, which calculates the Topographic Wetness Index directly from a DEM
...
You can also define the group under which the algorithm will be shown, using the \texttt{group} tag.
