...
public class AdditionalResultsDialog
   ...
   public AdditionalResultsDialog(final ArrayList components,
      ...
      super(mainFrame, Sextante.getText("Results"), false);
      ...
      this.addWindowListener(new WindowAdapter() {
         ...
         public void windowClosing(final WindowEvent e) {
            ((ArcGUIFactory) SextanteGUI.getGUIFactory()).setIsResultsDialogVisible(false);
         }
      });
   ...
   protected void showPopupMenu(final MouseEvent e) {
      ...
      if (c instanceof JScrollPane) {
         ...
         if (true/*view instanceof JTextPane*/) {
